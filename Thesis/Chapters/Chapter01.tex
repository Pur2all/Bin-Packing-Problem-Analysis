...
la versione di decisione del problema fa parte dell'insieme dei problemi NP-complete ed è così definita in "Computers and
Intractability":
\begin{quote}
...
bins fissato $ \geq 2 $ (Bin packing with fixed number of bins revisited, Klaus Jansen et al.) e in tempo polinomiale per
