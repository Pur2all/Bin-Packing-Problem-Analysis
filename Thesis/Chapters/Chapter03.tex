...
Una libreria nativa del linguaggio che permette di utilizzare una lista come uno heap ed eseguire i classici algoritmi relativi a uno heap su di essa in 
modo efficiente.\\
...
Una volta delineato il metodo da utilizzare per l'esperimento e realizzato il software che permette di eseguirlo vengono prodotti i dati relativi ad esso
per essere analizzati.

\subsection{Dati}
Di seguito varie immagini raffiguranti gli esiti degli esperimenti basati su istanze generate casualmente con distribuzione uniforme nell'intervallo
di interi $ [1, 1000] $.
